...
# The sharded async cache engine lives in gemma4_mtp.target_cache. Re-exported
# here so existing imports (`from gemma4_mtp.data import CacheDataset, ...`)
# keep working.
from gemma4_mtp.target_cache import CacheDataset, collate_cache  # noqa: E402,F401
